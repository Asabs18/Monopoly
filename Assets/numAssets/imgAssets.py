...
#BOARD IMAGE
board_img = pygame.image.load("Assets/imgAssets/boardAssets/board.png").convert_alpha()
...
#DIE IMAGES
sidePaths = [
            "Assets/imgAssets/diceAssets/dice1.png",
            "Assets/imgAssets/diceAssets/dice2.png",
            "Assets/imgAssets/diceAssets/dice3.png",
            "Assets/imgAssets/diceAssets/dice4.png",
            "Assets/imgAssets/diceAssets/dice5.png",
            "Assets/imgAssets/diceAssets/dice6.png",
        ]
...
#Boat
boat_img = pygame.image.load("Assets/imgAssets/pieceAssets/boat.png").convert_alpha()
boat_img = pygame.transform.smoothscale(boat_img.convert_alpha(), (ST_PIECE_WIDTH, ST_PIECE_HEIGHT))
STBOATIMG = boat_img

#Car
car_img = pygame.image.load("Assets/imgAssets/pieceAssets/car.png").convert_alpha()
car_img = pygame.transform.smoothscale(car_img.convert_alpha(), (ST_PIECE_WIDTH, ST_PIECE_HEIGHT))
STCARIMG = car_img

#Hat
hat_img = pygame.image.load("Assets/imgAssets/pieceAssets/hat.png").convert_alpha()
hat_img = pygame.transform.smoothscale(hat_img.convert_alpha(), (ST_PIECE_WIDTH, ST_PIECE_HEIGHT))
STHATIMG = hat_img

#Scope
scope_img = pygame.image.load("Assets/imgAssets/pieceAssets/scope.png").convert_alpha()
scope_img = pygame.transform.smoothscale(scope_img.convert_alpha(), (ST_PIECE_WIDTH, ST_PIECE_HEIGHT))
STSCOPEIMG = scope_img

#Shoe
shoe_img = pygame.image.load("Assets/imgAssets/pieceAssets/shoe.png").convert_alpha()
shoe_img = pygame.transform.smoothscale(shoe_img.convert_alpha(), (ST_PIECE_WIDTH, ST_PIECE_HEIGHT))
STSHOEIMG = shoe_img

#WheelBarrow
wheelbarrow_img = pygame.image.load("Assets/imgAssets/pieceAssets/wheelbarrow.png").convert_alpha()
...
#Railroad card img
railroad_img = pygame.image.load("Assets/imgAssets/cardAssets/railroad.png").convert_alpha()
...
waterworks_img = pygame.image.load("Assets/imgAssets/cardAssets/waterworks.png").convert_alpha()
...
#Tax card img
income_tax_img = pygame.image.load("Assets/imgAssets/cardAssets/income_tax.png").convert_alpha()
...
luxury_tax_img = pygame.image.load("Assets/imgAssets/cardAssets/luxury_tax.png").convert_alpha()
...
free_parking_img = pygame.image.load("Assets/imgAssets/cardAssets/free_parking.png").convert_alpha()
...
go_to_jail_img = pygame.image.load("Assets/imgAssets/cardAssets/go_to_jail.png").convert_alpha()
